#include "PFClusterProducerTestCudaHCAL.h"
...
PFClusterProducerTestCudaHCAL::PFClusterProducerTestCudaHCAL(const edm::ParameterSet& conf)
  : 
...
PFClusterProducerTestCudaHCAL::~PFClusterProducerTestCudaHCAL()
{
  //MyFile->Open();
  MyFile->cd();
  nTopo_CPU->Write();
...
void PFClusterProducerTestCudaHCAL::beginLuminosityBlock(const edm::LuminosityBlock& lumi, const edm::EventSetup& es) {
...
void PFClusterProducerTestCudaHCAL::produce(edm::Event& e, const edm::EventSetup& es) {
