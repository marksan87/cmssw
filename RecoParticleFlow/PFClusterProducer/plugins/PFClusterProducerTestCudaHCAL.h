#ifndef __newpf_PFClusterProducerTestCudaHCAL_H__
#define __newpf_PFClusterProducerTestCudaHCAL_H__
...
class PFClusterProducerTestCudaHCAL : public edm::stream::EDProducer<> {
...
public:
  PFClusterProducerTestCudaHCAL(const edm::ParameterSet&);
  ~PFClusterProducerTestCudaHCAL();
  ...
  //histos
  TFile *MyFile = new TFile("EvenHCAL.root","recreate");
...
DEFINE_FWK_MODULE(PFClusterProducerTestCudaHCAL);
