...
class PFClusterProducerECALCuda : public edm::stream::EDProducer<> {
...
public:
  PFClusterProducerECALCuda(const edm::ParameterSet&);
  ~PFClusterProducerECALCuda();
  ...
  TH1F *nTopoClusterCuda = new TH1F("nTopoClusterCuda","nTopoClusterCuda",5000,0,5000);
  TH2F *topoVS = new TH2F("topoVS","topoVS",500,0,500,500,0,500);
  ...
  TH2F *theMap2 = new TH2F("theMap2","theMap2",65,-2.825,2.825,72,-3.141592,3.1415926);
  TH2F *theMap3 = new TH2F("theMap3","theMap3",65,-2.825,2.825,72,-3.141592,3.1415926);
  TH2F *theMap4 = new TH2F("theMap4","theMap4",65,-2.825,2.825,72,-3.141592,3.1415926);
...
DEFINE_FWK_MODULE(PFClusterProducerECALCuda);
